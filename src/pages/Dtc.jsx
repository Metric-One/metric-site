...
// Shell only — invented specifics (iyzico, Klaviyo, 60-day LTV, CAPI claims)
// stripped. Real copy arrives page-by-page (see STRICT BUILD RULE in CLAUDE.md).
export default function Dtc() {
  ...
  return (
    <main className="mx-auto flex min-h-[60vh] max-w-6xl flex-col items-center justify-center px-5 text-center">
      <h1 className="font-display text-4xl font-bold tracking-tight">DTC</h1>
